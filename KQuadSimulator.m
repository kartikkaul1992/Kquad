...
function paint(state)
    Rx = makehgtform('xrotate', state.theta(1)); % Rotation matrix around X axis.
    Ry = makehgtform('yrotate', state.theta(2)); % Rotation matrix around Y axis.
    Rz = makehgtform('zrotate', state.theta(3)); % Rotation matrix around Z axis.
    Txyz = makehgtform('translate', state.x);    % Translation matix in space with respect x, y and z. 
